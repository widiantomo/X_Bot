...
Func _ClickMouse($Coordinates, $mouse_button="left", $number_of_clicks = 1)
	MouseUp("")
	BlockInput(1)
	MouseClick($mouse_button, ($Coordinates[0] - 200), ($Coordinates[1] - 100) , $number_of_clicks, 0)
	BlockInput(0)
EndFunc   ;==>_ClickMouse

Func _MoveMouse($Coordinates)
	MouseUp("")
	BlockInput(1)
	MouseMove(($Coordinates[0]+50),  ($Coordinates[1])-40, 0); instant($mouse_button, ($Coordinates[0] + $Coordinates[2]) / 2, ($Coordinates[1] + $Coordinates[3]) / 2, $number_of_clicks, 0)
	MouseClick("left", ($Coordinates[0]+50),  ($Coordinates[1])-40, 1)
	;MouseMove(($Coordinates[0]),  ($Coordinates[1]), 0); instant($mouse_button, ($Coordinates[0] + $Coordinates[2]) / 2, ($Coordinates[1] + $Coordinates[3]) / 2, $number_of_clicks, 0)
	;MouseClick("left", ($Coordinates[0]),  ($Coordinates[1]), 1)
	
	BlockInput(0)
EndFunc   ;==>_ClickMouse

Func _MoveMouse3($Coordinates)
	MouseUp("")
	BlockInput(1)
	MouseMove(($Coordinates[0])-70-8-25,  ($Coordinates[1])-50-50+25, 0); instant($mouse_button, ($Coordinates[0] + $Coordinates[2]) / 2, ($Coordinates[1] + $Coordinates[3]) / 2, $number_of_clicks, 0)
	MouseClick("left", ($Coordinates[0])-70-8-25,  ($Coordinates[1])-50-50+25, 1)
	sleep(1000)
	;MouseMove(($Coordinates[0]),  ($Coordinates[1]), 0); instant($mouse_button, ($Coordinates[0] + $Coordinates[2]) / 2, ($Coordinates[1] + $Coordinates[3]) / 2, $number_of_clicks, 0)
	;MouseClick("left", ($Coordinates[0]),  ($Coordinates[1]), 1)
